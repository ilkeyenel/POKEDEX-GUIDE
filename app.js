...
searchInput.addEventListener('input', (e) => {
    ...
    if (searchInput.value.toUpperCase() === searchInput.value) {
        // Eğer tüm harfler büyükse, küçük harfe çevir
    ...
    for (var turkishChar in turkishCharacters) {
        var englishChar = turkishCharacters[turkishChar];
        var regex = new RegExp(turkishChar, 'g');
        searchInput.value = searchInput.value.replace(regex, englishChar);
    }
